  ...
  startShowNativeAd() async {
    ...
    ATNativeManager.nativeAdReady(
      ...
      if (value == true) {
        ...
        EventBusUtil.eventBus.fire(
          NativeAdWidgetEvent(nativeWidget: getNativeView()),
        );
      } else {
    ...
    ATListenerManager.nativeEventHandler.listen((value) {
      switch (value.nativeStatus) {
        ...
        case NativeStatus.nativeAdDidFinishLoading:
          ...
          //到达展示场景，展示前检查是否准备就绪
          ATNativeManager.nativeAdReady(placementID: value.placementID).then((
            isReady,
          ) {
        ...
        case NativeStatus.nativeAdDidAdSourceBiddingAttempt:
          // TODO: Handle this case.
          throw UnimplementedError();
        case NativeStatus.nativeAdDidAdSourceBiddingFilled:
          // TODO: Handle this case.
          throw UnimplementedError();
        case NativeStatus.nativeAdDidAdSourceBiddingFail:
          // TODO: Handle this case.
          throw UnimplementedError();
        case NativeStatus.nativeAdDidAdSourceAttempt:
          // TODO: Handle this case.
          throw UnimplementedError();
        case NativeStatus.nativeAdDidAdSourceLoadFilled:
          // TODO: Handle this case.
          throw UnimplementedError();
        case NativeStatus.nativeAdDidAdSourceLoadFail:
          // TODO: Handle this case.
          throw UnimplementedError();
      }
    });
